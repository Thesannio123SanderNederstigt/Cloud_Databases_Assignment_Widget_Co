...
public class EnumerableIncludableRepository<TEntity, TProp> : IIncludableRepository<TEntity, TProp> where TEntity : class
{
    private readonly IIncludableQueryable<TEntity, IEnumerable<TProp>> _query;

    internal EnumerableIncludableRepository(IIncludableQueryable<TEntity, IEnumerable<TProp>> query)
    {
        _query = query;
    }
